...
// Simple toast provider without Radix UI
const ToastProvider = ({ children }: { children: React.ReactNode }) => {
  return <>{children}</>
}

// Simple toast viewport without Radix UI
...
// Simple toast component without Radix UI
...
// Simple toast action without Radix UI
...
// Simple toast close without Radix UI
...
// Simple toast title without Radix UI
...
// Simple toast description without Radix UI
